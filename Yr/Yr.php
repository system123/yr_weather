...
class Yr {
    ...
    public static function create($location, $cache_path, $cache_life = 10, $language = "english")
    {
        ...
        try {
            ...
            $yr->setLastUpdated(Yr::createFromFormat(self::XML_DATE_FORMAT, $meta['lastupdate']));
            $yr->setNextUpdate(Yr::createFromFormat(self::XML_DATE_FORMAT, $meta['nextupdate']));

            if(isset($sun['set'], $sun['rise'])) {
                $yr->setSunset(Yr::createFromFormat(self::XML_DATE_FORMAT, $sun['set']));
                $yr->setSunrise(Yr::createFromFormat(self::XML_DATE_FORMAT, $sun['rise']));
            }
    ...
    public static function createFromFormat($strptimeFormat, $date) {
